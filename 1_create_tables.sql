...
DROP TABLE VIDEOSTART_RAW;
DROP TABLE VIDEOSTART_DLT;
DROP TABLE DIMDATE_DLT;
DROP TABLE DIMPLATFORM_DLT;
DROP TABLE DIMSITE_DLT;
DROP TABLE DIMVIDEO_DLT;
DROP TABLE DIMDATE;
DROP TABLE DIMPLATFORM;
DROP TABLE DIMSITE;
DROP TABLE DIMVIDEO;
DROP TABLE FACTVIDEOSTART;
COMMIT;
...
-- DATETIME is defined as VARCHAR(12) in the format of '%Y%m%d%H%i' like '202001011521' to minute grain as required;
